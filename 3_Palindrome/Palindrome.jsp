<html>
	...
	<body>
		<h2><center><%
			...
			check_palindrome(out,num);
			%>
			
			<%!
			void check_palindrome(JspWriter out,int num) throws Exception
			{
				int org_num=num;
				int rev=0;
			...
			range_palindrome_number(out,start,endrange);
			%>
			
			<%!
			void range_palindrome_number(JspWriter out,int start,int endrange) throws Exception
			{
			...
			string_palindrome(out,s);
			%>
			
			<%!
			void string_palindrome(JspWriter out,String s) throws Exception
			{
				String org_s=s;
				String revs="";
				int len=s.length();
